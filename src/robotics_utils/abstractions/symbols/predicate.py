...
class Predicate(Hashable):
    ...
    def to_pddl(self) -> str:
        ...
        return f"({self.name}{(' ' + ' '.join(typed_variables)) if typed_variables else ''})"

    def get_parameter_type(self, param_name: str) -> str:
        """Retrieve the expected type of the named parameter.
    ...
    def compute_all_groundings(self, objects: Objects) -> set[GroundAtom]:
