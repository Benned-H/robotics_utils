...
from robotics_utils.vision import assign_random_colors
from robotics_utils.visualization import Displayable

if TYPE_CHECKING:
    from robotics_utils.vision import RGB, BoundingBox, RGBImage
...
@dataclass(frozen=True)
class DetectedBoundingBoxes(Displayable):
