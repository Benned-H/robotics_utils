; Propositional version of the "Storage" domain from IPC-5.
; Source: https://lpg.unibs.it/ipc-5/generators/index.html

; To generate new problems for the domain, run the associated problem generator.
;   To display its help menu:    ./tests/test_data/pddl/generate-storage-problems -h
