...
def test_robotics_utils_root() -> None:
    ...
    # Act - Construct a path that should point to the project's pyproject.toml and src folder
    pyproject_toml = ROBOTICS_UTILS_ROOT / "pyproject.toml"
    src_dir = ROBOTICS_UTILS_ROOT / "src"

    # Assert - Expect to find the root directory and the pyproject.toml file
